...
play {
  ...
  val lFSaw         = LFSaw.ar(freq = 1.0302194, iphase = leastChange)
  val c_0           = LFClipNoise.ar(leastChange)
  ...
  val freq_0        = AllpassN.ar(15.518214, maxDelayTime = 0.45230204, delayTime = -0.006679056, decayTime = decayTime)
  val a_0           = VarSaw.ar(freq = freq_0, iphase = 742.4219, width = -18.27692)
  val a_1           = QuadC.ar(freq = -2726.2134, a = a_0, b = 419.48956, c = 683.00226, xi = -0.0028438699)
